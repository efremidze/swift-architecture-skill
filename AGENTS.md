...
- **Run external benchmark suite**: `./scripts/run/benchmarks.py`
- **Validate benchmark architecture coverage**: `python3 ./scripts/validate/benchmark-coverage.py`
- **Run real-world corpus eval**: `python3 ./scripts/run/corpus.py`
- **Validate architecture consistency**: `python3 ./scripts/validate/architecture.py`
